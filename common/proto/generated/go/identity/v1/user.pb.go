...
type RegisterRequest struct {
	...
	Random        string                 `protobuf:"bytes,6,opt,name=random,proto3" json:"random,omitempty"` // The random used to generate the otp
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *FollowRequest) Reset() {
	*x = FollowRequest{}
	mi := &file_identity_v1_user_proto_msgTypes[28]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*FollowRequest) Descriptor() ([]byte, []int) {
	return file_identity_v1_user_proto_rawDescGZIP(), []int{28}
}
...
func (x *FollowResponse) Reset() {
	*x = FollowResponse{}
	mi := &file_identity_v1_user_proto_msgTypes[29]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*FollowResponse) Descriptor() ([]byte, []int) {
	return file_identity_v1_user_proto_rawDescGZIP(), []int{29}
}
...
func (x *UnfollowRequest) Reset() {
	*x = UnfollowRequest{}
	mi := &file_identity_v1_user_proto_msgTypes[30]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UnfollowRequest) Descriptor() ([]byte, []int) {
	return file_identity_v1_user_proto_rawDescGZIP(), []int{30}
}
...
func (x *UnfollowResponse) Reset() {
	*x = UnfollowResponse{}
	mi := &file_identity_v1_user_proto_msgTypes[31]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UnfollowResponse) Descriptor() ([]byte, []int) {
	return file_identity_v1_user_proto_rawDescGZIP(), []int{31}
}
...
const file_identity_v1_user_proto_rawDesc = "" +
	...
	"\asuccess\x18\x02 \x01(\bR\asuccess\x12\x18\n" +
	"\amessage\x18\x03 \x01(\tR\amessage\x12,\n" +
	"\x04data\x18\x04 \x01(\v2\x18.identity.v1.PrivateUserR\x04data\"\xb5\x01\n" +
	...
	"\x06random\x18\x06 \x01(\tR\x06random\"\x88\x01\n" +
	...
	"\asuccess\x18\x02 \x01(\bR\asuccess\x12\x18\n" +
	"\amessage\x18\x03 \x01(\tR\amessage\x12\x12\n" +
	"\x04data\x18\x04 \x01(\bR\x04data\"0\n" +
	...
	"\x13SORT_DIRECTION_DESC\x10\x022\xf9\x06\n" +
	"\vUserService\x12;\n" +
	...
	"\vCheckMobile\x12\x1f.identity.v1.CheckMobileRequest\x1a .identity.v1.CheckMobileResponse\x12A\n" +
	"\x06Follow\x12\x1a.identity.v1.FollowRequest\x1a\x1b.identity.v1.FollowResponse\x12G\n" +
	"\bUnfollow\x12\x1c.identity.v1.UnfollowRequest\x1a\x1d.identity.v1.UnfollowResponseB\fZ\n" +
