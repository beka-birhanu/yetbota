...
func (o *Photo) GetPostPhotos() PostPhotoSlice {
	if o == nil {
		return nil
	}
...
func (r *photoR) GetPostPhotos() PostPhotoSlice {
	if r == nil {
		return nil
	}
...
func (o *Photo) PostPhotos(mods ...qm.QueryMod) postPhotoQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"post_photos\".\"photo_id\"=?", o.ID),
	)
...
func (photoL) LoadPostPhotos(ctx context.Context, e boil.ContextExecutor, singular bool, maybePhoto any, mods queries.Applicator) error {
	var slice []*Photo
	var object *Photo
	...
	query := NewQuery(
		qm.From(`post_photos`),
		qm.WhereIn(`post_photos.photo_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *Photo) AddPostPhotos(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*PostPhoto) error {
	var err error
