...
type User struct {
	...
	Badges         types.StringArray `boil:"badges" json:"badges" toml:"badges" yaml:"badges"`
	Rating         int               `boil:"rating" json:"rating" toml:"rating" yaml:"rating"`
	Contributions  int               `boil:"contributions" json:"contributions" toml:"contributions" yaml:"contributions"`
	Status         string            `boil:"status" json:"status" toml:"status" yaml:"status"`
	Followers      int               `boil:"followers" json:"followers" toml:"followers" yaml:"followers"`
	Following      int               `boil:"following" json:"following" toml:"following" yaml:"following"`
	Role           string            `boil:"role" json:"role" toml:"role" yaml:"role"`
	Password       string            `boil:"password" json:"password" toml:"password" yaml:"password"`
	CreatedAt      time.Time         `boil:"created_at" json:"created_at" toml:"created_at" yaml:"created_at"`
	UpdatedAt      time.Time         `boil:"updated_at" json:"updated_at" toml:"updated_at" yaml:"updated_at"`
	ProfilePhotoID null.String       `boil:"profile_photo_id" json:"profile_photo_id,omitempty" toml:"profile_photo_id" yaml:"profile_photo_id,omitempty"`
...
var UserTableColumns = struct {
	...
	ProfilePhotoID: "users.profile_photo_id",
}
...
var UserWhere = struct {
	...
	Badges         whereHelpertypes_StringArray
	Rating         whereHelperint
	Contributions  whereHelperint
	Status         whereHelperstring
	Followers      whereHelperint
	Following      whereHelperint
	Role           whereHelperstring
	Password       whereHelperstring
	CreatedAt      whereHelpertime_Time
	UpdatedAt      whereHelpertime_Time
	ProfilePhotoID whereHelpernull_String
}{
	...
	Badges:         whereHelpertypes_StringArray{field: "\"users\".\"badges\""},
	Rating:         whereHelperint{field: "\"users\".\"rating\""},
	Contributions:  whereHelperint{field: "\"users\".\"contributions\""},
	Status:         whereHelperstring{field: "\"users\".\"status\""},
	Followers:      whereHelperint{field: "\"users\".\"followers\""},
	Following:      whereHelperint{field: "\"users\".\"following\""},
	Role:           whereHelperstring{field: "\"users\".\"role\""},
	Password:       whereHelperstring{field: "\"users\".\"password\""},
	CreatedAt:      whereHelpertime_Time{field: "\"users\".\"created_at\""},
	UpdatedAt:      whereHelpertime_Time{field: "\"users\".\"updated_at\""},
	ProfilePhotoID: whereHelpernull_String{field: "\"users\".\"profile_photo_id\""},
}
...
type userR struct {
	ProfilePhoto *Photo `boil:"ProfilePhoto" json:"ProfilePhoto" toml:"ProfilePhoto" yaml:"ProfilePhoto"`
}
...
func (o *User) GetProfilePhoto() *Photo {
	if o == nil {
		return nil
	}

	return o.R.GetProfilePhoto()
}

func (r *userR) GetProfilePhoto() *Photo {
	if r == nil {
		return nil
	}

	return r.ProfilePhoto
}
...
var (
	userAllColumns            = []string{"id", "first_name", "last_name", "username", "mobile", "badges", "rating", "contributions", "status", "followers", "following", "role", "password", "created_at", "updated_at", "profile_photo_id"}
	userColumnsWithoutDefault = []string{"first_name", "last_name", "username", "mobile", "password"}
	userColumnsWithDefault    = []string{"id", "badges", "rating", "contributions", "status", "followers", "following", "role", "created_at", "updated_at", "profile_photo_id"}
...
// ProfilePhoto pointed to by the foreign key.
func (o *User) ProfilePhoto(mods ...qm.QueryMod) photoQuery {
	queryMods := []qm.QueryMod{
		qm.Where("\"id\" = ?", o.ProfilePhotoID),
	}
...
// LoadProfilePhoto allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for an N-1 relationship.
func (userL) LoadProfilePhoto(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser any, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	if singular {
		...
		if !queries.IsNil(object.ProfilePhotoID) {
			args[object.ProfilePhotoID] = struct{}{}
		}
		...
		for _, obj := range slice {
			...
			if !queries.IsNil(obj.ProfilePhotoID) {
				args[obj.ProfilePhotoID] = struct{}{}
			}
	...
	if singular {
		...
		object.R.ProfilePhoto = foreign
		if foreign.R == nil {
			foreign.R = &photoR{}
		}
		foreign.R.ProfilePhotoUsers = append(foreign.R.ProfilePhotoUsers, object)
		return nil
	}

	for _, local := range slice {
		for _, foreign := range resultSlice {
			if queries.Equal(local.ProfilePhotoID, foreign.ID) {
				local.R.ProfilePhoto = foreign
				if foreign.R == nil {
					foreign.R = &photoR{}
				}
				foreign.R.ProfilePhotoUsers = append(foreign.R.ProfilePhotoUsers, local)
				break
			}
		}
	}
...
// SetProfilePhoto of the user to the related item.
// Sets o.R.ProfilePhoto to related.
// Adds o to related.R.ProfilePhotoUsers.
func (o *User) SetProfilePhoto(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Photo) error {
	var err error
	if insert {
	...
	queries.Assign(&o.ProfilePhotoID, related.ID)
	if o.R == nil {
		o.R = &userR{
			ProfilePhoto: related,
		}
	} else {
		o.R.ProfilePhoto = related
	}

	if related.R == nil {
		related.R = &photoR{
			ProfilePhotoUsers: UserSlice{o},
		}
	} else {
		related.R.ProfilePhotoUsers = append(related.R.ProfilePhotoUsers, o)
	}

	return nil
}

// RemoveProfilePhoto relationship.
// Sets o.R.ProfilePhoto to nil.
// Removes o from all passed in related items' relationships struct.
func (o *User) RemoveProfilePhoto(ctx context.Context, exec boil.ContextExecutor, related *Photo) error {
	var err error

	queries.SetScanner(&o.ProfilePhotoID, nil)
	if _, err = o.Update(ctx, exec, boil.Whitelist("profile_photo_id")); err != nil {
		return errors.Wrap(err, "failed to update local table")
	}

	if o.R != nil {
		o.R.ProfilePhoto = nil
	}
	if related == nil || related.R == nil {
		return nil
	}

	for i, ri := range related.R.ProfilePhotoUsers {
		if queries.Equal(o.ProfilePhotoID, ri.ProfilePhotoID) {
			continue
		}

		ln := len(related.R.ProfilePhotoUsers)
		if ln > 1 && i < ln-1 {
			related.R.ProfilePhotoUsers[i] = related.R.ProfilePhotoUsers[ln-1]
		}
		related.R.ProfilePhotoUsers = related.R.ProfilePhotoUsers[:ln-1]
		break
	}
	return nil
}
